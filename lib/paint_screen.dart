...
import 'package:scribble_io/sidebar/player_scoreboard__drawer.dart';
import 'package:scribble_io/waiting_lobby_screen.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = IO.io('http://192.168.232.89:3000', <String, dynamic>{
